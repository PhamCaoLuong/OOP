...
namespace JumperJumper
{
    public class ValueHolder
    {
        ...
        //physics
        public static Vector2 leftTenoIdlingRange = new Vector2((float)-.2, (float)-.1);
        public static Vector2 rightTenoIdlingRange = new Vector2((float).2, (float).1);
        ...
        public static int maxInvinciblityTime = 100;  // time no be attacked
